...
export default class App extends Component {
  ...
  render() {
    return (
      <div>
        {/* <NavBar/> */}
        {/* <News setProgress={this.setProgress} apiKey={this.apiKey}   setProgress={this.setProgress} apiKey={this.apiKey}   pageSize={this.pageSize} country="in" category="science"/> */}
        <Router>
          <NavBar />
          <LoadingBar
            height = {3}
          ...
          />
          <Routes>
            <Route exact path="/" element={<News setProgress={this.setProgress} apiKey={this.apiKey} key="technology" pageSize={this.pageSize} country="in" category="general" />}></Route>
